...
class ManagerLogin extends JFrame implements ActionListener, KeyListener {	//GUI 관리자 창 
	...
	public ManagerLogin() {
		...
		setVisible(true);
		setResizable(true);
		port_log.setBackground(Color.white);
		port_label.setFont(new Font("Serif",Font.BOLD,20));
		port_warn.setFont(new Font("Serif",Font.BOLD,13));
		port_btn.setFont(new Font("Serif",Font.BOLD,15));
		port_label.setForeground(Color.black);
		port_warn.setForeground(Color.red);
		port_btn.addActionListener(this);
		port_num.addKeyListener(this);
		port_log.add(imgLabel);
